...
Ghost.prototype.draw = function() {
	...
	if(this.isWeak){
		...
		switch(this.dir){
			...
			case UP:
				ctx.fillStyle="#0000FF"; //left eyeball
				ctx.beginPath();
				ctx.arc(this.x-this.radius/3, this.y-this.radius/5-this.radius/6, this.radius/6, 0, Math.PI*2, true); //#0000FF
				ctx.fill();

				ctx.fillStyle="#0000FF"; //right eyeball
				ctx.beginPath();
				ctx.arc(this.x+this.radius/3, this.y-this.radius/5-this.radius/6, this.radius/6, 0, Math.PI*2, true); //#0000FF
				ctx.fill();
			break;
			...
			case LEFT:
				ctx.fillStyle="#0000FF"; //left eyeball
				ctx.beginPath();
				ctx.arc(this.x-this.radius/3-this.radius/5, this.y-this.radius/5, this.radius/6, 0, Math.PI*2, true); //#0000FF
				ctx.fill();

				ctx.fillStyle="#0000FF"; //right eyeball
				ctx.beginPath();
				ctx.arc(this.x+this.radius/3-this.radius/15, this.y-this.radius/5, this.radius/6, 0, Math.PI*2, true); //#0000FF
				ctx.fill();
			break;
